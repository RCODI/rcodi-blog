...
Software supply chain attacks are an increasingly-worrying risk for both open source and closed source software. According to estimates, millions of dollars are lost every year to this attack vector (n.d.). The reason these attacks take place is due to the lack of visibility into what software used and how it moves throughout the software supply chain. In other words, there is a dire need to study and model software supply chain security risks.
